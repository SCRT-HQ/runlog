...
import { appliesFor, framesForGesture, landedOf, profileOf, revert, setupFor, type ControlProfile } from "../lib/handlers/control";
...
const landed = (over: Record<string, unknown>) => landedOf({ n: 4, tableId: "curse", entryId: "rot", ...over })!;
