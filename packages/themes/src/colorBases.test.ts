...
describe("built-in revision-1 color bases", () => {
  ...
  it.each(["superstar", "rainbow-road", "red-green-dark", "red-green-light", "blue-yellow-dark", "blue-yellow-light"])(
    "defaults %s to revision 1 and rejects an unavailable revision",
    (id) => {
