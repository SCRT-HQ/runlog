...
The sealed-copy container, on its own: `seal`, `open`, `readHeader`, `isSealed`, `generateLicenseKey`. It is a workspace package with no dependencies, so it runs wherever Web Crypto does.
