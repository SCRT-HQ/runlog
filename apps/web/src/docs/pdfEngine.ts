...
const FILES: Record<Face, string> = {
  "400-normal": literata400,
  "700-normal": literata700,
  "400-italic": literata400i,
  "700-italic": literata700i,
};
...
function loadEngine(): Promise<PdfEngine> {
  engine ??= import("pdfmake").then((mod) => {
    ...
    const pdfmake = ((mod as { default?: unknown }).default ?? mod) as PdfEngine & {
