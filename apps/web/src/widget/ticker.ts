 ...
 */
export type TickerKind = "rolled" | "outcome" | "award" | "clock" | "counter" | "unit-closed" | "run-ended";
...
const MARKS: Record<TickerKind, string> = { rolled: "Rolled", outcome: "Result", award: "Award", clock: "Clock", counter: "Tally", "unit-closed": "Closed", "run-ended": "Ended" };
