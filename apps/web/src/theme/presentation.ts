...
const COLOR_PROPERTIES = {
  ...
  "interaction.moveAccent": "--move-accent",
  "interaction.moveAccent2": "--move-accent-2",
  "interaction.moveAccent3": "--move-accent-3",
  "interaction.moveAccent4": "--move-accent-4",
...
export function compilePresentation(
  ...
  const presentation = {
    ...
    "--move-accent": colors.values["interaction.moveAccent"],
    "--move-accent-2": colors.values["interaction.moveAccent2"],
    "--move-accent-3": colors.values["interaction.moveAccent3"],
    "--move-accent-4": colors.values["interaction.moveAccent4"],
