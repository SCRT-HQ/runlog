...
export const GUIDE_PAGES: readonly GuidePage[] = [
  ...
  P(
    ...
    "Playing together",
    "Moderated play",
    "One person at the app, a roster of names, points on a grid.",
    Moderated,
  ),
  ...
  P(
    ...
    "What Runlog does for a stream, what it needs, and how it compares.",
    StreamWhy,
  ),
  ...
  P(
    ...
    "Why a browser source needs the live link's token, and how to copy it.",
    StreamAddress,
  ),
  ...
  P(
    ...
    "The numbers as JSON, and a socket that rings.",
    StreamTools,
  ),
  P(
    "control",
    ...
    "A tool beside the game does what the dice said, and puts it back after.",
    Control,
  ),
  P(
    "stream-troubles",
  ...
  P(
    ...
    "Discord",
    "Runlog in Discord",
    "A bot that hosts runs in your server: claim it, fill its vault, press the card.",
    Discord,
  ),
  P(
    "discord-setup",
    ...
    "Discord",
    "Setting a server up",
    "The install link, claiming, the vault, who hosts and where.",
    DiscordSetup,
  ),
  P(
    "discord-linking",
  ...
  P(
    ...
    "Moderated runs, modes played by several, the same run from the app.",
    DiscordTogether,
  ),
  ...
  P(
    ...
    "Discord",
    "What the bot stores",
    "The run, the server, the vault, and what of Discord's.",
    DiscordStored,
  ),
  // Making a pack
  ...
  P(
    ...
    "The command line",
    "Writing the paper",
    "The documents from the terminal, and one bundled file.",
    CliDocs,
  ),
  ...
  P(
    ...
    "Selling",
    "From your own hands",
    "Sign, seal a copy, send it; nothing else involved.",
    SellingYourself,
  ),
  P(
    "selling-marketplace",
    ...
    "A card, a sale on your Stripe account, a ledger.",
    SellingMarketplace,
  ),
  // Your account
  ...
  P(
    ...
    "Everything on your device first; what leaves it, and when.",
    Account,
  ),
  P(
    "stored",
  ...
  P(
    ...
    "On AWS, with accounts",
    "The hosted copy, run by you: what you need first.",
    Aws,
  ),
  P(
    "aws-config",
    ...
    "One JSON file per stage, and the pages that carry your name.",
    AwsConfig,
  ),
  P(
    "aws-deploy",
  ...
  P(
    ...
    "The secrets to fill, and the marketplace to seed.",
    AwsAfter,
  ),
  P(
    "monitoring",
  ...
  P(
    ...
    "What each message means, and where everything lives.",
    BotTroubles,
  ),
  // Reference
  P(
    ...
    null,
    "Reference",
    "The contracts, kept beside the code: the pack format, the stream API, selling from a backend.",
    Reference,
  ),
];
