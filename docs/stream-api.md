...
For an Elgato Stream Deck there is nothing to write: the Runlog plugin does all of this, and the guide's [A Stream Deck at the table](https://runlog.scrthq.com/guide/stream-deck) says what its keys do. What follows is for a deck of your own making.
