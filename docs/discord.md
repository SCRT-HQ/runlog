...
unlinked there or with `/unlink` in Discord. To move the link to another
Runlog account, run `/link` again and open the address signed in to that
one. Nothing of Discord's is kept but your user id and the name Discord
showed.
